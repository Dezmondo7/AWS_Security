  ...
  return (
    <main className="app-shell">
      <aside className={`sidebar ${mobileNav ? 'sidebar-open' : ''}`}>
        ...
        <div className="sidebar-footer"><button className="nav-item"><Users size={17} /><span>Contributors</span></button><button className="nav-item"><Settings2 size={17} /><span>Settings</span></button><div className="profile"><div className="avatar">JD</div><div><strong>Dale Warburton</strong><span>Administrator</span></div><div className="status-dot" /></div></div>
      </aside>
